...
st.line_chart(data=FixturesElementsAll2Filteredslim, x="event", y="AttackOpp_pergame", x_label=None, y_label=None,height=1,width=1, color="web_name", use_container_width=True)
